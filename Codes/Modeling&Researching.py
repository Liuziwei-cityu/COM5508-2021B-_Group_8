...
model=Model([input], output) ### MODEL 3 ###
model.compile(loss='sparse_categorical_crossentropy',
              optimizer='adam',
              metrics=['accuracy'])
model.summary()
...
with open("/Users/xidyugavin/Library/Mobile Documents/com~apple~CloudDocs/G's/Prostgraduate in CityU_HK/Sememter B/COM5508 Media Data Analytics/COM5508_Coding& Data/Bias/data/test/twitter2.csv") as testfile:
